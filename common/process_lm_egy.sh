...
if [ ! -f data/lm/$model/egymix1/arpa ]; then
   echo "arpa" missing
   exit 1
fi
...
common/extract_vocab_from_arpa.py < data/lm/$model/egymix1/arpa > data/lm/$model/vocab
...
if [ -f data/lm/$model/egymix2/arpa ]; then
...
common/make_recog_lang.sh --inwordbackoff false data/lm/$model/egymix1/arpa data/langs${lsuf}/$model data/recog_langs${lsuf}/${model}_egymix1
