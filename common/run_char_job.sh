...
if [ -f $dir/wordmap ] && [ -f $dir/vocab ]; then
...
ret=$(sbatch -p $partitions -t 4:00:00 --job-name=charseg -e $dir/log-%j.out -o $dir/log-%j.out --mem-per-cpu 4G -- common/train_charseg.py $dir)
echo $ret
