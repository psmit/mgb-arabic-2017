...
export PATH="$PWD/../ftk:$PWD/utils:$PWD:$PATH"

module load openfstpy kaldi/2017.05.30-a57eab6-GCC-5.4.0-mkl phonetisaurus anaconda3 anaconda2 srilm mitlm Morfessor sph2pipe variKN m2m-aligner openfst/1.6.2-GCC-5.4.0
